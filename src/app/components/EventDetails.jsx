        ...
        return (
            <div class="relative mb-4 min-h-32 mt-[15px]">
                <div class="relative z-10 flex w-full h-full">
                    ...
                    <div>
                    <h1 class="font-headline text-[64px] leading-[70px] text-black max-[1024px]:text-[42px] max-[1024px]:leading-10 max-[768px]:text-[50px] max-[768px]:pt-7 max-[768px]:leading-9  mb-4">{this.props.event.sports}</h1>
                    <div class="mb-4">
