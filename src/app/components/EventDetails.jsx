            ...
            <div class="relative mb-4 min-h-32">
                <div class="relative z-10 flex w-full h-full">
                    ...
                    <div class="mb-4">
                            ...
                            <p class="font-normal">{`${this.props.event.nom_site} (${this.props.event.code_site})`}</p>
                        </div>
                        <div class="mb-4">
                            <p class="text-xl font-bold">DATE DE DEBUT</p>
                            <p class="font-normal">{this.props.event.start_date}</p>
                        </div>
                        <div class="mb-4">
                            <p class="text-xl font-bold">DATE DE FIN</p>
                            <p class="font-normal">{this.props.event.end_date}</p>
                        </div>
