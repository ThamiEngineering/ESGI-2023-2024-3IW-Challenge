    ...
    render() {
        return (
            <div class="relative md:mb-10 md:mt-10 min-h-32">
                <h1 class="font-headline lg:text-9xl md:text-7xl text-4xl absolute lg:flex hidden md:top-[-40px] top-[-20px] left-0 opacity-5 z-0 text-black md:ml-8 ml-5">{this.props.title}</h1>
