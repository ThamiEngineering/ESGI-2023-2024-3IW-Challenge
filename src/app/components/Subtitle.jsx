        ...
        return (
            <div class="relative min-[426px]:mb-10 min-[769px]:min-h-32 max-[425px]:min-h-24">
                ...
                <div class="relative z-10 flex items-center ml-[90px] h-full">
                    ...
                    <h1 class="font-headline text-[64px] text-black min-[1025px]:mt-10 max-[1024px]:mt-7 max-[768px]:mt-4  max-[1024px]:text-[56px] max-[768px]:text-[42px] max-[426px]:text-[22px]">{this.props.title}</h1>
                </div>
            </div>
        );
    }
