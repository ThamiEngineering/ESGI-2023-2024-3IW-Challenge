...
export default class PageEvents extends Blink.Component {
    ...
    render() {
        ...
        return (
            Blink.createElement("div", {}, Blink.createElement(Navbar, {}),Blink.createElement("div", { "class":"my-12" }, Blink.createElement(Title, { "title":"Carte des événements" }),Blink.createElement("div", { "class":"relative z-20 mx-[88px]" }, Blink.createElement("div", { "id":"map" , "class":"w-auto h-[508px]" })),Blink.createElement("div", { "class":"relative flex mx-[88px] gap-4 top-2" }, Blink.createElement("div", { "class":"w-1/3" }, Blink.createElement("label", { "for":"filterSport" , "class":"block text-gray-700" }, "Filtrer par sport"),Blink.createElement("select", { "id":"filterSport" , "name":"filterSport" , "onChange":this.handleSportFilterChange, "class":"w-full p-2 border border-gray-300 rounded" }, Blink.createElement("option", { "value":"" }, "Choisir un sport"),                                ...sportOptions)),Blink.createElement("div", { "class":"w-1/3" }, Blink.createElement("label", { "for":"filterStartDate" , "class":"block text-gray-700" }, "Date de début"),Blink.createElement("input", { "id":"filterStartDate" , "type":"date" , "name":"filterDate" , "onChange":this.handleStartDateFilterChange, "class":"w-full p-2 border border-gray-300 rounded" })),Blink.createElement("div", { "class":"w-1/3" }, Blink.createElement("label", { "for":"filterEndDate" , "class":"block text-gray-700" }, "Date de fin"),Blink.createElement("input", { "id":"filterEndDate" , "type":"date" , "name":"filterDate" , "onChange":this.handleEndDateFilterChange, "class":"w-full p-2 border border-gray-300 rounded" })),Blink.createElement("div", { "class":"w-1/3" }, Blink.createElement("button", { "onClick":this.applyFilters, "class":"w-full p-2 bg-blue-500 text-white rounded mt-6" }, "                                Appliquer les filtres                            ")))),Blink.createElement("div", { "class":"my-12" }, Blink.createElement(Subtitle, { "title":"Prochain événement" }),Blink.createElement("div", { "class":"min-[769px]:grid min-[769px]:grid-cols-2 space-x-10 mx-[88px]" }, Blink.createElement("img", { "src":"../assets/images/Background.svg" , "alt":"img" , "class":"h-full w-auto object-cover" }),Blink.createElement(EventDetails, { "event":nextEvent}))),Blink.createElement("div", { "class":"my-12" }, Blink.createElement(Subtitle, { "title":"Événements à venir" }),Blink.createElement("div", { "class":"flex mx-[88px] gap-10 grid grid-cols-3 max-[768px]:grid-cols-2 max-[425px]:grid-cols-1" },                                             ...Array.from(                            { length: 3 },                            (_, index) => (                                Blink.createElement(CardEvents, { title: visibleEvents[index].sports })                            )                        )                    ),Blink.createElement("div", { "class":"flex gap-2 mx-[88px] mt-4" }, Blink.createElement("button", { "onClick":this.handlePrev, "class":"w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center" }, Blink.createElement("i", { "class":"fa fa-chevron-left text-white" })),Blink.createElement("button", { "onClick":this.handleNext, "class":"w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center" }, Blink.createElement("i", { "class":"fa fa-chevron-right text-white" })))),Blink.createElement(Footer, {}))
        );
    }
}